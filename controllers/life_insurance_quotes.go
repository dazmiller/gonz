...
type LifeInsuranceQuotesController struct {
	beego.Controller
}

func (c *LifeInsuranceQuotesController) URLMapping() {
...
// @router / [post]
func (c *LifeInsuranceQuotesController) Post() {
...
// @router /:id [get]
func (c *LifeInsuranceQuotesController) GetOne() {
	c.Ctx.Output.Header("Access-Control-Allow-Origin", "*")
...
// @Failure 403
// @router / [get]
func (c *LifeInsuranceQuotesController) GetAll() {
	c.Ctx.Output.Header("Access-Control-Allow-Origin", "*")
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *LifeInsuranceQuotesController) Put() {
	c.Ctx.Output.Header("Access-Control-Allow-Origin", "*")
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *LifeInsuranceQuotesController) Delete() {
	c.Ctx.Output.Header("Access-Control-Allow-Origin", "*")
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
